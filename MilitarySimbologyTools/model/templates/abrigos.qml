...
<qgis version="2.18.16" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="ValueMap" name="Tipo">
      <widgetv2config fieldEditable="1" constraint="" labelOnTop="0" constraintDescription="" notNull="0">
        <value key="" value=""/>
        <value key="Abrigo com armas automáticas" value="10"/>
        <value key="Abrigo com trincheira" value="5"/>
        <value key="Abrigo individual" value="1"/>
        <value key="Abrigo subterrâneo" value="3"/>
        <value key="Abrigo subterrâneo isolado" value="2"/>
        <value key="Abrigo superficial" value="4"/>
        <value key="Casamata de Concreto" value="8"/>
        <value key="Casamata de Concreto com torre blindada" value="9"/>
        <value key="Espaldão" value="7"/>
        <value key="Local fortificado" value="6"/>
      </widgetv2config>
    </edittype>
    <edittype widgetv2type="ValueMap" name="Situação">
      <widgetv2config fieldEditable="1" constraint="" labelOnTop="0" constraintDescription="" notNull="0">
        <value key="Não ocupado" value="2"/>
        <value key="Ocupado" value="1"/>
      </widgetv2config>
    </edittype>
    <edittype widgetv2type="TextEdit" name="Capacidade">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
  </edittypes>
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0">
    <rules key="{fb6c5083-ff7d-423f-a73f-e612cb37ad5d}">
      <rule filter=" &quot;Tipo&quot;   = 1 and  &quot;Situação&quot; =1" key="{187058da-0e88-4ad6-b7e2-b8d36bdac94c}" symbol="0" label="Abrigo subterrâneo isolado, ocupado"/>
      <rule filter=" &quot;Tipo&quot;   = 1 and  &quot;Situação&quot; =2" key="{228a903d-602f-4a17-9bb4-6a0919dadd34}" symbol="1" label="Abrigo subterrâneo, não ocupado"/>
      <rule filter=" &quot;Tipo&quot;   = 4 and  &quot;Situação&quot; =1" key="{d5737732-0c9a-404a-bda0-62e00f12ba02}" symbol="2" label="Abrigo superficial, ocupado"/>
      <rule filter=" &quot;Tipo&quot;   = 4 and  &quot;Situação&quot; =2" key="{187058da-0e88-4ad6-b7e2-b8d36bdac94c}" symbol="3" label="Abrigo superficial, não ocupado"/>
      <rule filter=" &quot;Tipo&quot;   = 5" key="{d5737732-0c9a-404a-bda0-62e00f12ba02}" symbol="4" label="Abrigo superficial, com trincheira"/>
      <rule filter=" &quot;Tipo&quot; =  6" key="{068a50b8-fab5-4e47-843a-780e0e60efcd}" symbol="5" label="Local fortificado"/>
      <rule filter=" &quot;Tipo&quot; =  7" key="{7c6301bf-6d95-4214-b071-6cec191442c0}" symbol="6" label="Espaldão"/>
      <rule filter=" &quot;Tipo&quot; =  8" key="{73e43623-51a5-41f5-aba2-eb03d35dbc53}" symbol="7" label="Casamata de Concreto"/>
      <rule filter=" &quot;Tipo&quot; = 9" key="{068a50b8-fab5-4e47-843a-780e0e60efcd}" symbol="8" label="Casamata de Concreto com torre blindada"/>
      <rule filter=" &quot;Tipo&quot; = 10" key="{73e43623-51a5-41f5-aba2-eb03d35dbc53}" symbol="9" label="Abrigo com armas automáticas"/>
    </rules>
    <symbols>
      <symbol alpha="1" clip_to_extent="1" type="marker" name="0">
        <layer pass="0" class="SimpleMarker" locked="0">
          <prop k="angle" v="0"/>
          <prop k="color" v="143,248,213,255"/>
  ...
  <aliases>
    ...
    <alias field="Situação" index="2" name=""/>
    <alias field="Capacidade" index="3" name=""/>
  </aliases>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column width="-1" hidden="0" type="field" name="Situação"/>
      <column width="-1" hidden="0" type="field" name="Capacidade"/>
    </columns>
  ...
  <defaults>
    ...
    <default field="Tipo" expression="1"/>
    <default field="Situação" expression=""/>
    <default field="Capacidade" expression=""/>
  </defaults>
