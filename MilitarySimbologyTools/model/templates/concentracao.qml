...
<qgis version="2.18.12" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="ValueMap" name="tipo">
      <widgetv2config fieldEditable="1" constraint="" labelOnTop="0" constraintDescription="" notNull="0">
        <value key="Br Bia 105mm" value="5"/>
        <value key="Br Bia 155mm" value="7"/>
        <value key="Br Gp 105mm" value="4"/>
        <value key="Br Gp 155mm" value="3"/>
        <value key="Br Pel Mrt Me (4 Pç)" value="6"/>
        <value key="Br Pel Mrt P ou Me (6 Pç)" value="8 "/>
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0">
    <rules key="{fb6c5083-ff7d-423f-a73f-e612cb37ad5d}">
      <rule filter=" &quot;tipo&quot;  = 1" key="{df9c3208-23be-40ea-b6df-7a5e4e496399}" symbol="0" label="Concentração"/>
      <rule filter=" &quot;tipo&quot;  = 2" key="{99672fa0-a124-4660-adef-9fdb238646aa}" symbol="1" label="Explosão Nuclear"/>
      <rule filter=" &quot;tipo&quot;  = 3" key="{9f7c61a1-434c-4a3a-8d7f-499dda117b86}" symbol="2" label="Br Gp 155mm"/>
      <rule filter=" &quot;tipo&quot;  = 4" key="{8d21fe5e-4787-4cb3-925a-67e5235c61cf}" symbol="3" label="Br Gp 105mm"/>
      <rule filter=" &quot;tipo&quot;  in (5,6)" key="{f522caa4-ba72-44d7-90ec-b39fceb4cd82}" symbol="4" label="Br Bia 105mm/Pel Mrt Me(4 Pç)"/>
      <rule filter=" &quot;tipo&quot;  in (7,8)" key="{05f41aab-5e86-400d-ab2c-832ae801da21}" symbol="5" label="Br Bia 155mm/Pel Mrt P ou Me(6 Pç)"/>
    </rules>
    <symbols>
      ...
      <symbol alpha="1" clip_to_extent="1" type="marker" name="1">
        <layer pass="0" class="SvgMarker" locked="0">
          ...
          <prop k="horizontal_anchor_point" v="1"/>
          <prop k="name" v="{path}/explisoes_nucleares.svg"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="0,0,0,0,0,0"/>
          <prop k="offset_unit" v="MM"/>
          <prop k="outline_color" v="0,0,0,255"/>
      ...
      <symbol alpha="1" clip_to_extent="1" type="marker" name="2">
        <layer pass="0" class="SimpleMarker" locked="0">
          <prop k="angle" v="90"/>
          <prop k="color" v="143,191,123,255"/>
          <prop k="horizontal_anchor_point" v="1"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="name" v="line"/>
          <prop k="offset" v="0,0"/>
  ...
  <labeling type="rule-based">
    <rules key="{8416f913-5cdb-49b5-b939-c888ac788f7d}">
      <rule description="Concentração" filter=" &quot;tipo&quot;  = 1" key="{26070ddd-e1de-4cbf-a4e6-60f697f7bae7}">
        <settings>
          ...
          <placement repeatDistanceUnit="1" placement="1" maxCurvedCharAngleIn="25" repeatDistance="0" distInMapUnits="0" labelOffsetInMapUnits="1" xOffset="50" distMapUnitScale="0,0,0,0,0,0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" preserveRotation="1" repeatDistanceMapUnitScale="0,0,0,0,0,0" centroidWhole="0" priority="5" yOffset="-30" offsetType="0" placementFlags="10" centroidInside="0" dist="0" angleOffset="0" maxCurvedCharAngleOut="-25" fitInPolygonOnly="0" quadOffset="2" labelOffsetMapUnitScale="0,0,0,0,0,0"/>
      ...
      <rule description="Barragens" filter=" &quot;tipo&quot;  in (3,4,5,6,7,8)" key="{39d06e6f-f37e-4489-9296-e29ede81e22c}">
        <settings>
          <text-style fontItalic="0" fontFamily="Arial Black" fontLetterSpacing="0" fontUnderline="0" fontWeight="87" fontStrikeout="0" textTransp="0" previewBkgrdColor="#ffffff" fontCapitals="0" textColor="0,0,0,255" fontSizeInMapUnits="1" isExpression="0" blendMode="0" fontSizeMapUnitScale="0,0,0,0,0,0" fontSize="70" fieldName="Indicativo" namedStyle="Black" fontWordSpacing="0" useSubstitutions="0">
            <substitutions/>
          </text-style>
          <text-format placeDirectionSymbol="0" multilineAlign="3" rightDirectionSymbol=">" multilineHeight="1" plussign="0" addDirectionSymbol="0" leftDirectionSymbol="&lt;" formatNumbers="0" decimals="3" wrapChar="" reverseDirectionSymbol="0"/>
          <text-buffer bufferSize="1" bufferSizeMapUnitScale="0,0,0,0,0,0" bufferColor="255,255,255,255" bufferDraw="0" bufferBlendMode="0" bufferTransp="0" bufferSizeInMapUnits="0" bufferNoFill="0" bufferJoinStyle="128"/>
