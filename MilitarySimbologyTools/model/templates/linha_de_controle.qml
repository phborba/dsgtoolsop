...
<qgis version="2.18.11" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="UniqueValues" name="nome">
      <widgetv2config fieldEditable="0" constraint="" labelOnTop="0" constraintDescription="" notNull="0" Editable="1"/>
    </edittype>
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0">
    <rules key="{37af8617-5541-4eca-82d2-624c378d6fa8}">
      <rule filter=" &quot;tipo&quot;  = 1" key="{dde4ccf5-4121-4458-b955-2fe375ef5fcc}" symbol="0" label="Linha de Partida"/>
      <rule filter="&quot;tipo&quot;  = 2" key="{fde90ec7-fbe0-47e3-88a2-67c509b3e755}" symbol="1" label="Linha de Contato"/>
      <rule filter=" &quot;tipo&quot; = 3" key="{b280aa5e-b763-4131-b059-a93071330fa9}" symbol="2" label="Linha de Controle"/>
      <rule filter=" &quot;tipo&quot;  = 4" key="{08c18e92-e5b3-49a7-b50b-ae6151ceb68c}" symbol="3" label="Linha de Cabeça de Ponte Aeromóvel"/>
      <rule filter=" &quot;tipo&quot; = 5" key="{0de1e15b-b49f-4453-b605-71727b2cd24d}" symbol="4" label="Linha de Cabeça de Ponte Aérea"/>
      <rule filter="ELSE" key="{7d68fd71-90ba-4d7e-b13d-a22f9b207084}" symbol="5" label="Erro"/>
    </rules>
    <symbols>
        ...
        <layer pass="0" class="MarkerLine" locked="0">
          ...
          <symbol alpha="1" clip_to_extent="1" type="marker" name="@0@1">
            <layer pass="0" class="FontMarker" locked="0">
              ...
              <prop k="offset" v="5.07368000000000041,0"/>
              <prop k="offset_map_unit_scale" v="0,0,0,0,0,0"/>
              <prop k="offset_unit" v="MM"/>
            ...
            <layer pass="0" class="FontMarker" locked="0">
              ...
              <prop k="horizontal_anchor_point" v="1"/>
              <prop k="joinstyle" v="miter"/>
              <prop k="offset" v="1.84210999999999991,0"/>
              <prop k="offset_map_unit_scale" v="0,0,0,0,0,0"/>
              <prop k="offset_unit" v="MM"/>
              <prop k="outline_color" v="255,255,255,255"/>
              <prop k="outline_width" v="0"/>
        ...
        <layer pass="0" class="MarkerLine" locked="0">
          ...
          <symbol alpha="1" clip_to_extent="1" type="marker" name="@0@2">
            ...
            <layer pass="0" class="FontMarker" locked="0">
              ...
              <prop k="horizontal_anchor_point" v="1"/>
              <prop k="joinstyle" v="miter"/>
              <prop k="offset" v="-5.09999999999999964,0"/>
              <prop k="offset_map_unit_scale" v="0,0,0,0,0,0"/>
              <prop k="offset_unit" v="MM"/>
              <prop k="outline_color" v="255,255,255,255"/>
              <prop k="outline_width" v="0"/>
        ...
        <layer pass="0" class="MarkerLine" locked="0">
          ...
          <symbol alpha="1" clip_to_extent="1" type="marker" name="@1@1">
            ...
            <layer pass="0" class="FontMarker" locked="0">
              ...
              <prop k="horizontal_anchor_point" v="1"/>
              <prop k="joinstyle" v="miter"/>
              <prop k="offset" v="2.60000000000000009,0"/>
              <prop k="offset_map_unit_scale" v="0,0,0,0,0,0"/>
              <prop k="offset_unit" v="MM"/>
              <prop k="outline_color" v="255,255,255,255"/>
              <prop k="outline_width" v="0"/>
        ...
        <layer pass="0" class="MarkerLine" locked="0">
          ...
          <symbol alpha="1" clip_to_extent="1" type="marker" name="@1@2">
            <layer pass="0" class="FontMarker" locked="0">
              ...
              <prop k="horizontal_anchor_point" v="1"/>
              <prop k="joinstyle" v="miter"/>
              <prop k="offset" v="-2.20000000000000018,0"/>
              <prop k="offset_map_unit_scale" v="0,0,0,0,0,0"/>
              <prop k="offset_unit" v="MM"/>
              <prop k="outline_color" v="255,255,255,255"/>
              <prop k="outline_width" v="0"/>
        ...
        <layer pass="0" class="MarkerLine" locked="0">
          ...
          <symbol alpha="1" clip_to_extent="1" type="marker" name="@2@0">
            ...
            <layer pass="0" class="FontMarker" locked="0">
              ...
              <prop k="horizontal_anchor_point" v="1"/>
              <prop k="joinstyle" v="miter"/>
              <prop k="offset" v="4.70000000000000018,0"/>
              <prop k="offset_map_unit_scale" v="0,0,0,0,0,0"/>
              <prop k="offset_unit" v="MM"/>
              <prop k="outline_color" v="255,255,255,255"/>
              <prop k="outline_width" v="0"/>
  ...
  <labeling type="rule-based">
    <rules key="{40830407-8aeb-44ae-a401-ea0426e1b1fc}">
      <rule description="LC Pnt Amv" filter=" &quot;tipo&quot;  = 4" key="{892e3a4e-4986-4d7b-ae7a-54c14a13b067}">
        <settings>
          <text-style fontItalic="0" fontFamily="Arial" fontLetterSpacing="0.375" fontUnderline="0" fontWeight="75" fontStrikeout="0" textTransp="0" previewBkgrdColor="#ffffff" fontCapitals="0" textColor="0,0,0,255" fontSizeInMapUnits="0" isExpression="1" blendMode="0" fontSizeMapUnitScale="0,0,0,0,0,0" fontSize="13" fieldName="'LC Pnt Amv'" namedStyle="Bold" fontWordSpacing="0" useSubstitutions="0">
            <substitutions/>
          </text-style>
          ...
          <text-buffer bufferSize="0.6" bufferSizeMapUnitScale="0,0,0,0,0,0" bufferColor="222,222,222,255" bufferDraw="1" bufferBlendMode="0" bufferTransp="0" bufferSizeInMapUnits="0" bufferNoFill="0" bufferJoinStyle="64"/>
          ...
          <placement repeatDistanceUnit="1" placement="2" maxCurvedCharAngleIn="20" repeatDistance="0" distInMapUnits="0" labelOffsetInMapUnits="1" xOffset="0" distMapUnitScale="0,0,0,0,0,0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" preserveRotation="1" repeatDistanceMapUnitScale="0,0,0,0,0,0" centroidWhole="0" priority="10" yOffset="0" offsetType="0" placementFlags="9" centroidInside="0" dist="0" angleOffset="0" maxCurvedCharAngleOut="-20" fitInPolygonOnly="0" quadOffset="4" labelOffsetMapUnitScale="0,0,0,0,0,0"/>
      ...
      <rule description="LC Pnt Ae" filter=" &quot;tipo&quot;  = 5" key="{936f974e-fa20-4f7c-a6d5-5c76dd3de0b7}">
        <settings>
          <text-style fontItalic="0" fontFamily="Arial" fontLetterSpacing="0.375" fontUnderline="0" fontWeight="75" fontStrikeout="0" textTransp="0" previewBkgrdColor="#ffffff" fontCapitals="0" textColor="0,0,0,255" fontSizeInMapUnits="0" isExpression="1" blendMode="0" fontSizeMapUnitScale="0,0,0,0,0,0" fontSize="13" fieldName="'LC Pnt Ae'" namedStyle="Bold" fontWordSpacing="0" useSubstitutions="0">
            <substitutions/>
          </text-style>
          <text-format placeDirectionSymbol="0" multilineAlign="0" rightDirectionSymbol=">" multilineHeight="1" plussign="0" addDirectionSymbol="0" leftDirectionSymbol="&lt;" formatNumbers="0" decimals="3" wrapChar="" reverseDirectionSymbol="0"/>
          <text-buffer bufferSize="0.6" bufferSizeMapUnitScale="0,0,0,0,0,0" bufferColor="222,222,222,255" bufferDraw="1" bufferBlendMode="0" bufferTransp="0" bufferSizeInMapUnits="0" bufferNoFill="0" bufferJoinStyle="64"/>
  ...
  <aliases>
    ...
    <alias field="rot_simb" index="3" name=""/>
  </aliases>
  ...
  <defaults>
    ...
    <default field="rot_simb" expression=""/>
  </defaults>
