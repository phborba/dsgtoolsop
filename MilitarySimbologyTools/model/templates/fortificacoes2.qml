...
<qgis version="2.18.16" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="ValueMap" name="Tipo">
      <widgetv2config fieldEditable="1" constraint="" labelOnTop="0" constraintDescription="" notNull="0">
        ...
        <value key="Sapa" value="11"/>
        <value key="Trabalhos de OT, construído e não ocupado" value="14"/>
        <value key="Trabalhos de OT, construído e ocupado" value="12"/>
        <value key="Trabalhos de OT, construído e ocupado pelo inimigo" value="16"/>
        <value key="Trabalhos de OT, em construção" value="15"/>
        <value key="Trincheira" value="13"/>
      </widgetv2config>
    </edittype>
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0">
    <rules key="{fb6c5083-ff7d-423f-a73f-e612cb37ad5d}">
      <rule filter=" &quot;Tipo&quot;   = 1" key="{6c1a98c3-6b48-4bcf-b99d-bb384d534c5c}" symbol="0" label="Abrigo Individual"/>
      <rule filter=" &quot;Tipo&quot;   =2 and  &quot;Situação&quot; =1" key="{1514d549-b994-4458-92d5-72d74cf3f478}" symbol="1" label="Abrigo subterrâneo isolado, ocupado"/>
      <rule filter=" &quot;Tipo&quot;   =2 and  &quot;Situação&quot; =2" key="{11e430df-3b26-4ec9-8a09-5a0dfcb0ce27}" symbol="2" label="Abrigo subterrâneo isolado,não  ocupado"/>
      <rule filter=" &quot;Tipo&quot;   =4and  &quot;Situação&quot; =1" key="{8970f610-8d11-4a5f-893a-0ed50c6dd22e}" symbol="3" label="Abrigo superficail, ocupado"/>
      <rule filter=" &quot;Tipo&quot;   =4 and  &quot;Situação&quot; =2" key="{187058da-0e88-4ad6-b7e2-b8d36bdac94c}" symbol="4" label="Abrigo superficial,não  ocupado"/>
      <rule filter=" &quot;Tipo&quot;   = 5" key="{7b91e721-5927-4256-bbd5-4b29a9b7c3d8}" symbol="5" label="Abrigo superficial, com trincheira"/>
      <rule filter=" &quot;Tipo&quot; =  6" key="{068a50b8-fab5-4e47-843a-780e0e60efcd}" symbol="6" label="Local fortificado"/>
      <rule filter=" &quot;Tipo&quot; =  7" key="{7c6301bf-6d95-4214-b071-6cec191442c0}" symbol="7" label="Espaldão"/>
      <rule filter=" &quot;Tipo&quot; =  8" key="{070c5ab4-6182-486b-9973-1926aa79fa8f}" symbol="8" label="Casamata de Concreto"/>
      <rule filter=" &quot;Tipo&quot; =  9" key="{73e43623-51a5-41f5-aba2-eb03d35dbc53}" symbol="9" label="Casamata de Concreto com Torre Blindada"/>
      <rule filter=" &quot;Tipo&quot; = 10" key="{0fd4b329-d2d3-4106-a2f6-e8d9205764bc}" symbol="10" label="Abrigo com armas automáticas"/>
      <rule filter=" &quot;Tipo&quot; = 11" key="{3ed3126c-41c6-47de-87b2-9a23f67683f0}" symbol="11" label="Sapa"/>
      <rule filter=" &quot;Tipo&quot; = 12" key="{78a57e11-cab7-4345-bf22-caa9ad070aa6}" symbol="12" label="Trabalho OT construido e ocupado"/>
      <rule filter=" &quot;Tipo&quot; = 13" key="{462d5189-c4c7-4ee8-aa46-dd25518867bd}" symbol="13" label="Trincheira"/>
      <rule filter=" &quot;Tipo&quot; = 15" key="{73e43623-51a5-41f5-aba2-eb03d35dbc53}" symbol="14" label="Trabalho OT em construcao"/>
      <rule filter=" &quot;Tipo&quot; = 16" key="{3df16736-12d3-411b-a88e-66ef8215bcc0}" symbol="15" label="Trabalho OT construido e ocupado INIMIGO"/>
      <rule filter=" &quot;Tipo&quot; = 14" key="{e930e452-523d-48b2-97c9-94dadb901b57}" symbol="16" label="Trabalho OT construido e não ocupado"/>
    </rules>
    <symbols>
      ...
      <symbol alpha="1" clip_to_extent="1" type="marker" name="5">
        <layer pass="0" class="SvgMarker" locked="0">
          ...
          <prop k="color" v="143,248,213,255"/>
          <prop k="horizontal_anchor_point" v="1"/>
          <prop k="name" v="C:/Users/Pedro Reis/.qgis2/python/plugins/DsgTools/DsgToolsOp/MilitaryTools/MilitarySimbologyTools/model/symbols/Abrigo_Superficial_Ocupado_Trincheira.svg"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="0,0,0,0,0,0"/>
          <prop k="offset_unit" v="MM"/>
          <prop k="outline_color" v="0,0,0,255"/>
      ...
      <symbol alpha="1" clip_to_extent="1" type="marker" name="7">
        ...
        <layer pass="0" class="SimpleMarker" locked="0">
          ...
          <prop k="joinstyle" v="bevel"/>
          <prop k="name" v="line"/>
          <prop k="offset" v="-10,-12.79999999999999005"/>
          <prop k="offset_map_unit_scale" v="0,0,0,0,0,0"/>
          <prop k="offset_unit" v="MM"/>
          <prop k="outline_color" v="0,0,0,255"/>
          <prop k="outline_style" v="solid"/>
        ...
        <layer pass="0" class="SimpleMarker" locked="0">
          ...
          <prop k="joinstyle" v="bevel"/>
          <prop k="name" v="line"/>
          <prop k="offset" v="-10,12.80000000000000071"/>
          <prop k="offset_map_unit_scale" v="0,0,0,0,0,0"/>
          <prop k="offset_unit" v="MM"/>
          <prop k="outline_color" v="0,0,0,255"/>
          <prop k="outline_style" v="solid"/>
  ...
  <labeling type="rule-based">
    <rules key="{dc02b425-ef66-4c6e-9051-33b6fcf921c5}">
      <rule filter=" &quot;Tipo&quot;  in (1,2,3,4)" key="{21be6c41-3fd2-49d7-88e8-91d5a4ecf411}">
        <settings>
          <text-style fontItalic="0" fontFamily="MS Shell Dlg 2" fontLetterSpacing="0" fontUnderline="0" fontWeight="75" fontStrikeout="0" textTransp="0" previewBkgrdColor="#ffffff" fontCapitals="0" textColor="0,0,0,255" fontSizeInMapUnits="1" isExpression="0" blendMode="0" fontSizeMapUnitScale="0,0,0,0,0,0" fontSize="25" fieldName="Capacidade" namedStyle="Bold" fontWordSpacing="0" useSubstitutions="0">
            <substitutions/>
          </text-style>
          ...
          <placement repeatDistanceUnit="1" placement="1" maxCurvedCharAngleIn="25" repeatDistance="0" distInMapUnits="1" labelOffsetInMapUnits="1" xOffset="-60" distMapUnitScale="0,0,0,0,0,0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" preserveRotation="1" repeatDistanceMapUnitScale="0,0,0,0,0,0" centroidWhole="0" priority="5" yOffset="0" offsetType="0" placementFlags="10" centroidInside="0" dist="0" angleOffset="0" maxCurvedCharAngleOut="-25" fitInPolygonOnly="0" quadOffset="3" labelOffsetMapUnitScale="0,0,0,0,0,0"/>
