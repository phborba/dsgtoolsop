...
<qgis version="2.18.11" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="ValueMap" name="tipo">
      <widgetv2config fieldEditable="1" constraint="" labelOnTop="0" constraintDescription="" notNull="0">
        <value key="Área de coordenação de fogos" value="1"/>
        <value key="Área de explosões nucleares" value="3"/>
        <value key="Área de fogo proibído" value="2"/>
      </widgetv2config>
    </edittype>
    ...
    <edittype widgetv2type="TextEdit" name="descricao">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="gdh">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
  </edittypes>
  ...
  <aliases>
    ...
    <alias field="designacao" index="2" name="Designação"/>
    <alias field="descricao" index="3" name="Descrição"/>
    <alias field="gdh" index="4" name="GDH"/>
  </aliases>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column width="-1" hidden="0" type="field" name="descricao"/>
      <column width="-1" hidden="0" type="field" name="gdh"/>
    </columns>
  ...
  <defaults>
    ...
    <default field="descricao" expression=""/>
    <default field="gdh" expression=""/>
  </defaults>
