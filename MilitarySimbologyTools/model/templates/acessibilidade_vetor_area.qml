  ...
  <edittypes>
    ...
    <edittype widgetv2type="ValueMap" name="tipo">
      <widgetv2config fieldEditable="1" constraint="" labelOnTop="0" constraintDescription="" notNull="0">
        <value key="Adequado" value="1"/>
        <value key="Impeditivo" value="3"/>
        <value key="Restritivo" value="2"/>
      </widgetv2config>
    </edittype>
  </edittypes>
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0">
    <rules key="{45eecff4-99f1-4075-b0ae-d2b73959c90b}">
      <rule filter=" &quot;tipo&quot;  = 3" key="{7aba7119-be80-429c-85a4-482de9b365ee}" symbol="0" label="IMPEDITIVO"/>
      <rule filter=" &quot;tipo&quot; = 1" key="{3c93c0c2-3e38-4aeb-b11a-43b76975ddde}" symbol="1" label="ADEQUADO"/>
      <rule filter=" &quot;tipo&quot; =2" key="{f9a605c5-8514-4b40-b1b7-a6e4935053d0}" symbol="2" label="RESTRITIVO"/>
    </rules>
    <symbols>
      <symbol alpha="1" clip_to_extent="1" type="fill" name="0">
        <layer pass="0" class="SimpleFill" locked="0">
          <prop k="border_width_map_unit_scale" v="0,0,0,0,0,0"/>
          <prop k="color" v="255,7,7,255"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="0,0,0,0,0,0"/>
          <prop k="offset_unit" v="MM"/>
          <prop k="outline_color" v="255,8,8,255"/>
      ...
      <symbol alpha="1" clip_to_extent="1" type="fill" name="2">
        <layer pass="0" class="SimpleFill" locked="0">
          <prop k="border_width_map_unit_scale" v="0,0,0,0,0,0"/>
          <prop k="color" v="255,239,8,255"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="0,0,0,0,0,0"/>
          <prop k="offset_unit" v="MM"/>
          <prop k="outline_color" v="255,239,8,255"/>
          <prop k="outline_style" v="solid"/>
          <prop k="outline_width" v="0.66"/>
          <prop k="outline_width_unit" v="MM"/>
