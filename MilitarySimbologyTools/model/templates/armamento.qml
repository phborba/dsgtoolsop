...
<qgis version="2.18.11" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="ValueMap" name="tipo">
      <widgetv2config fieldEditable="1" constraint="" labelOnTop="0" constraintDescription="" notNull="0">
        <value key="Bateria de canhões" value="11"/>
        <value key="Bateria de obuseiros" value="14"/>
        <value key="Canhão" value="8"/>
        <value key="Canhão antiaéreo" value="9"/>
        <value key="Canhão anticarro" value="10"/>
        <value key="Canhão sem recuo" value="2"/>
        <value key="Fuzil metralhador" value="3"/>
        <value key="Fuzil metralhador (não ocupada)" value="4"/>
        <value key="Lança granada" value="1"/>
        <value key="Metralhadora" value="7"/>
        <value key="Metralhadora montada para tiro antiaéreo" value="5"/>
        <value key="Metralhadora multipla antiaérea" value="6"/>
        <value key="Míssil ou foguete superfície-superfície" value="15"/>
        <value key="Míssil superfície-ar" value="16"/>
        <value key="Míssil superfície-superfície anticarro" value="17"/>
        <value key="Obuseiro ou morteiro" value="12"/>
        <value key="Obuseiro ou morteiro (não ocupado)" value="13"/>
      </widgetv2config>
    </edittype>
    <edittype widgetv2type="UniqueValues" name="calibre">
      <widgetv2config fieldEditable="1" constraint="" labelOnTop="0" constraintDescription="" notNull="0" Editable="1"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="rotacao">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="cor">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
  </edittypes>
  ...
  <aliases>
    ...
    <alias field="calibre" index="2" name="Calibre"/>
    <alias field="rotacao" index="3" name="Rotação"/>
    <alias field="cor" index="4" name="Cor"/>
  </aliases>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column width="-1" hidden="0" type="field" name="calibre"/>
      <column width="-1" hidden="0" type="field" name="rotacao"/>
  ...
  <defaults>
    ...
    <default field="calibre" expression=""/>
    <default field="rotacao" expression=""/>
