  ...
  <edittypes>
    ...
    <edittype widgetv2type="ValueMap" name="Tipo">
      <widgetv2config fieldEditable="1" constraint="" labelOnTop="0" constraintDescription="" notNull="0">
        <value key="" value=""/>
        <value key="Sapa" value="1"/>
        <value key="Trabalho de Organização do Terreno" value="2"/>
        <value key="Trincheira" value="3"/>
      </widgetv2config>
    </edittype>
    <edittype widgetv2type="ValueMap" name="Situação">
      <widgetv2config fieldEditable="1" constraint="" labelOnTop="0" constraintDescription="" notNull="0">
        <value key="Construído e ocupado" value="1"/>
        <value key="Construído e ocupados pelo inimigo" value="4"/>
        <value key="Construído, mas não ocupado" value="2"/>
    ...
    <symbols>
      <symbol alpha="1" clip_to_extent="1" type="line" name="0">
        <layer pass="0" class="SimpleLine" locked="0">
          ...
          <prop k="line_color" v="166,96,152,255"/>
