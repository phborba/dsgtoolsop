...
<qgis version="2.4.0-Chugiak" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
    ...
    <symbols>
      <symbol alpha="1" type="fill" name="0">
        <layer pass="0" class="SimpleFill" locked="0">
          ...
          <prop k="color" v="122,140,182,255"/>
  ...
  <customproperties>
    ...
    <property key="labeling/fieldName" value="ZONE"/>
  ...
  <edittypes>
    <edittype labelontop="0" editable="1" name="ZONE"/>
    <edittype labelontop="0" editable="1" name="ROW"/>
    <edittype labelontop="0" editable="1" name="EAST_VALUE"/>
    <edittype labelontop="0" editable="1" name="CM_VALUE"/>
    <edittype labelontop="0" editable="1" name="WEST_VALUE"/>
    <edittype labelontop="0" editable="1" name="Perimeter"/>
    <edittype labelontop="0" editable="1" name="Area"/>
    <edittype labelontop="0" editable="1" name="Acres"/>
    <edittype labelontop="0" editable="1" name="Hectares"/>
  </edittypes>
  <editform></editform>
