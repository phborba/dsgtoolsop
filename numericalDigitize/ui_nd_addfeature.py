...
class Ui_Nd_AddFeature(object):
    def setupUi(self, Nd_AddFeature):
        ...
        self.addFromFileButton = QtGui.QPushButton(Nd_AddFeature)
        self.addFromFileButton.setObjectName(_fromUtf8("addFromFileButton"))
    ...
    def retranslateUi(self, Nd_AddFeature):
        Nd_AddFeature.setWindowTitle(_translate("Nd_AddFeature", u"Adicionar feição numérica", None))
        self.lblNumericalFeature.setText(_translate("Nd_AddFeature", u"Adicionar feição numérica:", None))
        ...
        self.addFromFileButton.setText(_translate("Nd_AddFeature", u"Adicionar a partir de arquivo...", None))
        self.groupBox.setTitle(_translate("Nd_AddFeature", u"Coordenadas são fornecidas", None))
        self.rb_ProjectCrs.setText(_translate("Nd_AddFeature", u"no sistema de referência do projeto", None))
        self.rb_LayerCrs.setText(_translate("Nd_AddFeature", u"no sistema de referência da camada", None))
        self.rb_OtherCrs.setText(_translate("Nd_AddFeature", u"em outro sistema de referência", None))
        self.l_OtherCrsName.setText(_translate("Nd_AddFeature", u"não selecionado", None))
        self.pb_ChooseCrs.setText(_translate("Nd_AddFeature", u"Selecionar", None))